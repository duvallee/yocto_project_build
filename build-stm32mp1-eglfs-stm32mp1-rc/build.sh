...
export TOP_DIR=`pwd`
export DEPLOY_DIR=${TOP_DIR}/tmp-glibc/deploy/images/stm32mp1-rc
export SDCARD_SHELL_SCRIPT=${DEPLOY_DIR}/scripts/create_sdcard_from_flashlayout.sh
export FLASHLAYOUT_FILE=${DEPLOY_DIR}/flashlayout_image-stm32mp1-rc/extensible/FlashLayout_sdcard_stm32mp157c-dk2-extensible.tsv
...
# MAIN LOOP
{
   ...
   bitbake image-stm32mp1-rc -c cleanall
   bitbake image-stm32mp1-rc
   ...
   then
      ...
      rm -f ../release/st32mp157c-dk2-rc-car.img
   fi
   ...
   mv ${DEPLOY_DIR}/FlashLayout_sdcard_stm32mp157c-dk2-extensible.raw ../release/st32mp157c-dk2-rc-car.img
}
